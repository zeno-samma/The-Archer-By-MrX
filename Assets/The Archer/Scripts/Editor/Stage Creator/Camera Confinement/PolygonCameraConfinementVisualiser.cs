...
{
    public class PolygonCameraConfinementVisualiser : CameraConfinementVisualiser
    {
        ...
        protected virtual SerializedProperty GetPointsProperty(SerializedProperty roomProperty)
        {
            ...
            if (pointsProperty.arraySize == 0)
            {
                ...
                pointsProperty.GetArrayElementAtIndex(2).vector2Value = Vector2.up + Vector2.right;
                pointsProperty.GetArrayElementAtIndex(3).vector2Value = Vector2.down + Vector2.right;
            }
            else if (pointsProperty.arraySize == 1)
            {
                ...
                pointsProperty.GetArrayElementAtIndex(2).vector2Value = pointsProperty.GetArrayElementAtIndex(0).vector2Value + Vector2.up + Vector2.right;
                pointsProperty.GetArrayElementAtIndex(3).vector2Value = pointsProperty.GetArrayElementAtIndex(0).vector2Value + Vector2.down + Vector2.right;
            } else if(pointsProperty.arraySize == 2)
            {
                pointsProperty.arraySize = 4;
                pointsProperty.GetArrayElementAtIndex(2).vector2Value = pointsProperty.GetArrayElementAtIndex(0).vector2Value + Vector2.right;
                pointsProperty.GetArrayElementAtIndex(3).vector2Value = pointsProperty.GetArrayElementAtIndex(1).vector2Value + Vector2.right;
            } else if(pointsProperty.arraySize == 3)
            {
                pointsProperty.arraySize = 4;
                pointsProperty.GetArrayElementAtIndex(2).vector2Value = pointsProperty.GetArrayElementAtIndex(0).vector2Value + Vector2.right;
            }
        ...
        protected virtual void DrawPolygon(SerializedProperty pointsProperty)
        {
            ...
            for (int i = 0; i < pointsProperty.arraySize; i++)
            {
                ...
                var nextPointProperty = i != pointsProperty.arraySize - 1 ? pointsProperty.GetArrayElementAtIndex(i + 1) : pointsProperty.GetArrayElementAtIndex(0);
        ...
        public override void OnSceneGUI(SerializedProperty roomProperty)
        {
            ...
            else if (closestPointId != -1)
            {
                ...
                if (distance < 0.6f)
                {
                    if (DrawHandle(closestPointId, closestPointProperty) && pointsProperty.arraySize > 4)
                    {
