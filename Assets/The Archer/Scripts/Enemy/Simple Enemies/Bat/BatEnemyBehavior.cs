...
{
    public class BatEnemyBehavior : EnemyBehavior
    {
        ...
        protected virtual void SpawnProjectile()
        {
            ...
            projectile.transform.forward = projectileSpawnPosition.forward.NormalizeXZ();

            projectile.Target = Target != null ? Target.transform : null;
