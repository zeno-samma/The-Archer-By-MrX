...
{
    public class TrapEnemyBehavior : EnemyBehavior
    {
        ...
        [Space]
        [SerializeField] protected AudioData detectingSound;
        ...
        protected IEasingCoroutine chargeSoundVolumeCoroutine;
        ...
        protected virtual IEnumerator AttackCoroutine()
        {
            ...
            GameController.AudioManager.PlayAudio(detectingSound);
        ...
        protected virtual IEnumerator MovementCoroutine()
        {
            ...
            if (chargeSoundSource != null)
            {
                chargeSoundVolumeCoroutine = chargeSoundSource.DoVolume(0, 0.3f).SetOnFinish(() =>
                {
        ...
        protected virtual void OnPlayerDefeated()
        {
            if (chargeSoundSource != null)
            {
                ...
                chargeSoundSource.Stop();
                chargeSoundSource = null;
                chargeSoundVolumeCoroutine.StopIfExists();
            }
        }
