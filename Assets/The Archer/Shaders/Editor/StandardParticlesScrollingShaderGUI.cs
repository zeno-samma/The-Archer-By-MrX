...
{
    public class StandardParticlesScrollingShaderGUI : ShaderGUI
    {
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            scrollingVelocity = FindProperty("_ScrollingVelocity", props);
            rimColor = FindProperty("_RimColor", props);
            rimStrength = FindProperty("_RimStrength", props);
            rimGradient = FindProperty("_RimGradient", props);
            rimDirectional = FindProperty("_RimDirectional", props);
        ...
        public void ShaderPropertiesGUI(Material material)
        {
            ...
            EditorGUI.BeginChangeCheck();
            {
                ...
                m_MaterialEditor.VectorProperty(scrollingVelocity, scrollingVelocity.displayName);
                m_MaterialEditor.ColorProperty(rimColor, rimColor.displayName);
                m_MaterialEditor.RangeProperty(rimStrength, rimStrength.displayName);
                m_MaterialEditor.RangeProperty(rimGradient, rimGradient.displayName);
                m_MaterialEditor.RangeProperty(rimDirectional, rimDirectional.displayName);
            ...
            baseColor.colorValue = albedoColor.colorValue;
            baseMap.textureValue = albedoMap.textureValue;
